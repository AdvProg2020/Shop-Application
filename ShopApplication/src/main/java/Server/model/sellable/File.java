...
public class File extends Sellable {
    private static final String DEFAULT_IMAGE_PATH = "src/main/resources/server_resources/default-file-pic.png";
    private static final Map<String, File> allFiles = new HashMap<>();
