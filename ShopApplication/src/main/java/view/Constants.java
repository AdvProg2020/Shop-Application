...
public final class Constants {
    ...
    public static class Actions {
        ...
        public static final String adminCreateDiscountCodeCommand = "create discount code";
        public static final String adminCreateDiscountCodePattern = caseInsensitiveMode + adminCreateDiscountCodeCommand + "$";
        public static final String adminShowDiscountCodesCommand = "show discount codes";
        public static final String adminShowDiscountCodesPattern = caseInsensitiveMode + "^" + adminShowDiscountCodesCommand + "$";
        public static final String adminViewDiscountCodeCommand = "view discount code [index]";
        public static final String adminViewDiscountCodePattern = caseInsensitiveMode + "^view discount code" + spacePattern + unsignedIntPattern + "$";
        public static final String adminEditDiscountCodeCommand = "edit discount code [index]";
        public static final String adminEditDiscountCodePattern = caseInsensitiveMode + "^edit discount code" + spacePattern + unsignedIntPattern + "$";
        public static final String adminRemoveDiscountCodeCommand = "remove discount code [index]";
        public static final String adminRemoveDiscountCodePattern = caseInsensitiveMode + "^remove discount code" + spacePattern + unsignedIntPattern + "$";
